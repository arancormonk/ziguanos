...
pub fn testApDebug() !void {
    ...
    ap_debug.init(4); // Simulate 4 APs
    serial.println("[SMP TEST] Initialized debug state for 4 APs", .{});

    // Test 2: Update stage for simulated APs
